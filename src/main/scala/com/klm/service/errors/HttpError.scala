...
case class ServiceUnavailableHttp(message: String) extends HttpError {
  override val statusCode: StatusCode = ServiceUnavailable
  override val code: String           = "Service unavailable"
}
...
case class BadRequestErrorHttp(reason: String) extends HttpError {
  override val statusCode: StatusCode = BadRequest
  override val code: String           = "BadRequestError"
